...
--Receipt Issued
INSERT INTO receipt_issued (id, amount, compensation_date, creation_date, currency, document_type, expiration_date, referenced_document_id, status, compensation_document_id, member_id, payment_method_id, payment_term_id, user_id) VALUES (200, -2400,'2017-01-09','2017-01-09','ARS','RCI','2017-01-09', 0, 'CLOSED' ,100, 100,1, 1,100);
...
INSERT INTO template_entry_line (id, entry_line_discriminator, accounting_entry_item_type, factor, account_id, payment_method_id, template_entry_id) VALUES(106, 'ENTRY_LINE_PAYMENT_METHOD','DEBIT',1,800,4,101);
INSERT INTO template_entry_line (id, entry_line_discriminator, accounting_entry_item_type, factor, account_id, payment_term_id, template_entry_id) VALUES(107, 'ENTRY_LINE_PAYMENT_TERM','DEBIT',0.1,10500,3,101);

INSERT INTO template_entry_line (id, entry_line_discriminator, accounting_entry_item_type, document_type, factor, account_id, template_entry_id)     VALUES(108, 'ENTRY_LINE_COMPENSATED_DOC_TYPE','CREDIT','FRI',1,2100,101);
